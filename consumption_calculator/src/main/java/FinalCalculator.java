...
*/
    public void writeSql() throws SQLException, JRException, IOException {
        ...
        String fileNamePdf = userDirectory + "/ConsumptionResults.pdf";
        String fileNameHtml = userDirectory + "/ConsumptionResults.html";
        String fileNameXls = userDirectory + "/ConsumptionResults.xls";
        String fileNameExc = userDirectory + "/ConsumptionResults.xlsx";
     ...
     //   Connection helper = DriverManager.getConnection("jdbc:mysql://localhost:3306/electricityconsumption","root","WebIntegrationProject");
        ...
        try{
            ...
            Connection con=DriverManager.getConnection(
                    "jdbc:mysql://localhost:3306/electricityconsumption","root","");
    ...
    //        INSERT INTO `electricityconsumption`.`appliances` (`id`, `cost`) VALUES ('1', '30');
       //     INSERT INTO `electricityconsumption`.`appliances` (`id`, `cost`) VALUES ('2', '20');
           ...
           // PreparedStatement pstmt = con.prepareStatement("UPDATE `appliances` SET (id,washing,cooking) VALUE (?,?,?)");
            PreparedStatement pstmt = con.prepareStatement("UPDATE `appliances` SET `price` = ? WHERE (`name` = 'cleaning')");
...
*/
           ...
           del.executeUpdate();
            ...
            con.close();
        }catch(Exception e){ System.out.println("EXCEPTION ON DATABASE");}

...
public class JasperExport {
   ...
   // String fileNameHtml = userDirectory + "/Hello.html";
    ...
    //JasperPrint print = new JasperPrint();
        ...
        Connection helper = DriverManager.getConnection("jdbc:mysql://localhost:3306/electricityconsumption","root","");
    ...
    */
        ...
        case "HTML":
            ...
            FileUtils.writeByteArrayToFile(new File("ConsumptionResults.html"), outputStream.toByteArray());
            System.out.println("Successfully completed the export");
